...
async def send_button(interaction):
    ...
    description=(
        "После заполнения заявки ожидайте сообщение от бота в ЛС с результатом\n\n"

        "<a:7706policeexplorer:1472049651447238882>  **GOS INFO**  <a:7706policeexplorer:1472049651447238882>\n"
        " - Получаете инвайт в нашу гос. фракцию (сейчас LSCSD) и попадаете в отдел(ы) \n"
        " - Ежедневно получаете контент во фракции\n"
        " - Хороший ,активный, а главное дружный коллектив\n"
        " - Дальнейшая перспектива для развития по рангу/в должности\n\n"

        "<:92201gun:1471690145811136767>  **CRIME INFO**  <:92201gun:1471690145811136767>\n"
        " - Возможность играть капты\n"
        " - Обеспечение зафуллом каждый капт\n"
        " - Перспектива для развития как каптер\n\n"

        "<a:7197blackdiamond:1465501676331991294>  **ЧТО ТРЕБУЕТСЯ ОТ ВАС:**  <a:7197blackdiamond:1465501676331991294>\n"
        "1. Желание играть и развиваться с семьей\n"
        "2. Адекватное поведение\n"
        "3. Актив во фракции/на каптах\n"
        "4. Возраст  -  от 15+\n"
        "5. Смена фамилии\n\n"

        " ↓ нажми кнопку ниже, чтобы подать заявку"
    ),
    color=discord.Color(int("660000", 16))
)
